...
function renderTabla(){
    ...
    .then((resp) => resp.json())
    .then(function(data) {
        /* Se borra el contenido viejo de la tabla y se escribe el nuevo */
        tabla.innerHTML="";
...
function renderChat(){
    ...
    .then(function(data) {
        ...
        //Denormaliza la respuesta del servidor
        ...
        //Se escribe el porcentaje
        document.getElementById('porcentaje').innerHTML= `Compresion: ${compresion}%`


        /* Se borr el contenido viejo de la tabla y se escribe el nuevo */
        tabla.innerHTML="";
...
function enviarChat(){
    /* Se armanda request para la funcion fetch */
    const url = '/api/chat';
    let data = {
        author:{ 
    ...
    fetch(url, request)
        .then(function() {
            /* Se renderiza la tabla para todos los clientes conectados y se la info del input del mensaje */
...
function logout(){
    ...
    .then(function(data){
        if (data) {
            ...
            x.innerHTML = "Nos vemos pronto "+data.user
            setTimeout(function(){
