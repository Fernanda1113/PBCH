...
const cart = require("./files/cart");
const carritos = new cart(__dirname + "/files/cart.json");
...
server.post("/", (req, res) => {
  ...
  return res.render("public/cart.hbs", { list: content, showList: boolean });
});
...
server.delete("/:id", (req, res) => {
  ...
  return res.render("public/cart.hbs", { list: content, showList: false });
});
